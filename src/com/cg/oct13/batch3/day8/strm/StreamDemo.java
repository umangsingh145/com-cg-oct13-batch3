package com.cg.oct13.batch3.day8.strm;
...
public class StreamDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nUsing filter() to get specified data ");
		Stream<Employee> employeesWithMoreSalary = empStream.filter(point -> point.salary > 15000);

//		Stream<Employee> employeesWithMoreSalary = empStream.filter(e -> e.salary > 19000);
		employeesWithMoreSalary.forEach(point -> System.out.println(point));
...
//
    	Stream<Employee> skipFirstThreeEmp=empList.stream().skip(4);
    	skipFirstThreeEmp.forEach(point->System.out.println(point));
    	
    	List<Double> salaryHike=empList.stream().map(point->point.salary+=1000).collect(Collectors.toList());
    	salaryHike.forEach(point->System.out.println(point));
